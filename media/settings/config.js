...
// contoh ['1','2','3']
// ['1','2','3','4']
global.ownerNumber = [`${global.owner}`,'254725100848','no3'] // no owner yang dapat mengakses all fitur
global.email = "eliudnjora53@gmail.com" // kosongkan jika tidak punya
...
global.packname = "eliud bot" // wm yg ada di sticker
global.author = "eliud de Lesta" // wm yg ada di sticker
...
- Price List
   • Rp. 10.000 (temporarily)
   • Rp. 50.000 (permanent)
  
  <\> Keuntungan
  - Antilink group
  - notification welcome, goodbye, promote, demote
  - set welcome, goodbye
  - management group 
...
global.mess = {
    group: "Message for Group club only 👥👥👥👥",
    owner: "Command for the bot owner -- ELIUD --",
    Badmin: "MUST BE AN  ADMIN!",
}
